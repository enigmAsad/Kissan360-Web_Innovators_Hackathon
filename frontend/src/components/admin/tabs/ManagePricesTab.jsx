...
const ManagePricesTab = () => {
  ...
  return (
    <div className="content-card">
      <h2>Price Entry</h2>
      <p style={{ color: '#94a3b8', marginBottom: 20 }}>Add or update prices for products across different cities and dates</p>
        ...
        {filteredItems.map(item => (
          <div className="feature-card" key={item._id} style={{ textAlign: 'left' }}>
            ...
            <button
              ...
              style={{ width: '100%', padding: '10px 12px', fontSize: 13, marginBottom: 0, background: 'linear-gradient(135deg, #10b981, #059669)' }}
      ...
      {showPriceModal && (
        <div className="modal-overlay" onClick={() => setShowPriceModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <h2>Manage Price: {selectedItem?.name}</h2>
            ...
            <form onSubmit={handlePriceSubmit} className="signup-form">
              ...
              {priceForm.city === '__NEW__' && (
                <div className="form-group">
                  <label htmlFor="newCity">New City Name</label>
                  <input
                    id="newCity"
              ...
              <div className="form-group">
                <label htmlFor="price">Price (per {selectedItem?.unit})</label>
                <input
                  type="number"
                  step="0.01"
                  min="0"
...
export default ManagePricesTab;
